...
func (p *XConsoleLog) Error(format string, a ...interface{}) error {
	return p.errorx(XConsoleLogDefaultlogID, format, a...)
}

// Errorx implements XLogger
func (p *XConsoleLog) Errorx(logID, format string, a ...interface{}) error {
