...
func (l *LogManager) Error(format string, a ...interface{}) (err error) {
	l.lock.RLock()
	defer l.lock.RUnlock()
...
func (l *LogManager) Errorx(logID, format string, a ...interface{}) (err error) {
	l.lock.RLock()
	defer l.lock.RUnlock()
	...
	for _, v := range l.loggers {
		...
		v.logger.Errorx(logID, format, a...)
	}
