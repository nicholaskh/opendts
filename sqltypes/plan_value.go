...
func (pv PlanValue) ResolveValue(bindVars map[string]*proto.BindVariable) (Value, error) {
	switch {
	case pv.Key != "":
...
func (pv PlanValue) lookupValue(bindVars map[string]*proto.BindVariable) (*proto.BindVariable, error) {
...
func (pv PlanValue) ResolveList(bindVars map[string]*proto.BindVariable) ([]Value, error) {
	switch {
	case pv.ListKey != "":
...
func (pv PlanValue) lookupList(bindVars map[string]*proto.BindVariable) (*proto.BindVariable, error) {
...
func rowCount(pvs []PlanValue, bindVars map[string]*proto.BindVariable) (int, error) {
	count := -1
...
func ResolveRows(pvs []PlanValue, bindVars map[string]*proto.BindVariable) ([][]Value, error) {
